...
## Resources
- Official Exam Guide (PDF): Claude Certified Architect — Foundations Certification Exam Guide
- Anthropic Academy (Skilljar): 13 free self-paced courses
- Anthropic docs: docs.anthropic.com
- Claude Agent SDK docs
- MCP specification: modelcontextprotocol.io
- Hands-on practice with Claude Code, Agent SDK, and MCP servers

## Time Estimate
~16 sessions over 8 weeks (flexible schedule, 2-3 sessions/week, ~1.5 hrs each)
